...
document
  .getElementById("closeMonthlyModalBtn")
...
document
  .getElementById("createMonthlyTableBtn")
  ?.addEventListener("click", async function () {
    ...
    try {
      ...
      // Get structure from the current table (Nov_2025_2)
        ...
        setTimeout(() => {
          ...
          if (successToast) {
            successToast.querySelector(
              "span"
            ).textContent = `Table "${tableName}" created successfully!`;
